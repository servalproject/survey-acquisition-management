 ...
 *
 */
public class EventSurveysAdapter extends SimpleCursorAdapter {
	 ...
	 */
	public EventSurveysAdapter(Context context, int layout, Cursor c, String[] from, int[] to, int flags) {
