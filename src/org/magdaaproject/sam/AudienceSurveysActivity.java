...
/**
 * view a list of survey forms associated with the audience category
 */
public class AudienceSurveysActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_audience_surveys);
		...
		mButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				AudienceSurveysActivity.this.finish();
			}
			
		});
		
		// get a reference to the grid view
		gridView = (GridView)findViewById(R.id.audience_surveys_ui_grid);
		...
		mSelectionArgs[0] = FormsContract.CATEGORY_AUDIENCE;
